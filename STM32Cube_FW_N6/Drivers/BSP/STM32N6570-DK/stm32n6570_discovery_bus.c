/**
  ******************************************************************************
  * @file    stm32n6570_discovery_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32N6570-DK board (MB1736) from
  *          STMicroelectronics
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32N6570_DK_BUS BUS
  * @{
  */

/** @defgroup STM32N6570_DK_BUS_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32N6570_DK_BUS_Private_Types Private Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32N6570_DK_BUS_Private_Constants
  * @{
  */
...
/** @defgroup STM32N6570_DK_BUS_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32N6570_DK_BUS_Exported_Functions Exported Functions
  * @{
  */
...
int32_t BSP_I2C1_RegisterMspCallbacks (BSP_I2C_Cb_t *Callback)
{
  ...
  if (HAL_I2C_RegisterCallback(&hbus_i2c1, HAL_I2C_MSPINIT_CB_ID, Callback->MspInitCallback) != HAL_OK)
  {
    ret = BSP_ERROR_PERIPH_FAILURE;
  }
  else if (HAL_I2C_RegisterCallback(&hbus_i2c1, HAL_I2C_MSPDEINIT_CB_ID, Callback->MspDeInitCallback) != HAL_OK)
  {
    ret = BSP_ERROR_PERIPH_FAILURE;
  }
  else
...
int32_t BSP_I2C2_RegisterMspCallbacks (BSP_I2C_Cb_t *Callback)
{
  ...
  /* Register MspInit/MspDeInit Callbacks */
  if (HAL_I2C_RegisterCallback(&hbus_i2c2, HAL_I2C_MSPINIT_CB_ID, Callback->MspInitCallback) != HAL_OK)
  {
    ret = BSP_ERROR_PERIPH_FAILURE;
  }
  else if (HAL_I2C_RegisterCallback(&hbus_i2c2, HAL_I2C_MSPDEINIT_CB_ID, Callback->MspDeInitCallback) != HAL_OK)
  {
    ret = BSP_ERROR_PERIPH_FAILURE;
  }
  else
...
/** @defgroup STM32N6570_DK_BUS_Private_Functions Private Functions
  * @{
  */
/**
